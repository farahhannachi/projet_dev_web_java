...
public class ReservationFormController {
    ...
    private void handleReserve() {
        ...
        try {
            ...
            if (reservationService.add(reservation)) {
                NotificationUtil.showSuccess("Reservation enregistree avec succes.\n\nUn email sera envoye si la configuration SMTP est disponible.");
                clearForm();
    ...
    private void closeWindow() {
        ...
        } else if (nomClientField != null && nomClientField.getScene() != null) {
