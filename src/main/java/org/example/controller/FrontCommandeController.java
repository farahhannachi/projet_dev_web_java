            ...
            if (mailerService.canSend()) {
                ...
                if (mailerService.getLastError() != null && !mailerService.getLastError().isBlank()) {
                    new Alert(Alert.AlertType.WARNING,
                            "Commande creee, mais l'email n'a pas pu etre envoye: " + mailerService.getLastError())
                            .showAndWait();
                }
            } else {
                new Alert(Alert.AlertType.WARNING,
                        "Commande creee, mais l'email n'est pas configure: " + mailerService.getConfigurationStatus())
                        .showAndWait();
            }
