...
public class DepotService {
    private static final String INSERT_SQL_WITH_LOCATION = """
        INSERT INTO depot (
            nom_depot,
            adresse_depot,
            ville,
    ...
    private static final String INSERT_SQL_WITHOUT_LOCATION = """
        INSERT INTO depot (
            nom_depot,
            adresse_depot,
            ville,
    ...
    private static final String UPDATE_SQL_WITH_LOCATION = """
        UPDATE depot
        SET nom_depot=?,
            adresse_depot=?,
            ville=?,
    ...
    private static final String UPDATE_SQL_WITHOUT_LOCATION = """
        UPDATE depot
        SET nom_depot=?,
            adresse_depot=?,
            ville=?,
    ...
    private Boolean hasLocationNameColumn;
    ...
    public boolean add(Depot depot) throws ValidationException {
        ...
        try (Connection conn = DatabaseUtil.getConnection();
             PreparedStatement stmt = conn.prepareStatement(
                     hasLocationNameColumn(conn) ? INSERT_SQL_WITH_LOCATION : INSERT_SQL_WITHOUT_LOCATION,
    ...
    public boolean update(Depot depot) throws ValidationException {
        ...
        try (Connection conn = DatabaseUtil.getConnection();
             PreparedStatement stmt = conn.prepareStatement(
                     hasLocationNameColumn(conn) ? UPDATE_SQL_WITH_LOCATION : UPDATE_SQL_WITHOUT_LOCATION)) {
    ...
    private boolean hasLocationNameColumn(Connection connection) throws SQLException {
        if (hasLocationNameColumn != null) {
            return hasLocationNameColumn;
        }
        ...
        try (PreparedStatement statement = connection.prepareStatement(sql);
            ...
            hasLocationNameColumn = resultSet.next() && resultSet.getInt(1) > 0;
            return hasLocationNameColumn;
        }
    }
