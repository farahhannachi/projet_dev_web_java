...
class OrdonnanceFrontController extends AbstractController
{
    ...
    ): Response
    {
        ...
        if ($ordonnance->getUtilisateur()->getId() !== $this->getUser()->getId()) {
    ...
    ): Response
    {
        ...
        if (!$ordonnance) {
            ...
            $numeroOrdonnance = 'ORD-' . date('YmdHis') . '-' . $this->getUser()->getId();
            ...
            if (!$hasError) {
                ...
                if ($isNew) {
                    ...
                    $pusherService->notifyNewOrdonnance([
                        ...
                        'patient' => $ordonnance->getUtilisateur()->getNom() . ' ' . $ordonnance->getUtilisateur()->getPrenom(),
