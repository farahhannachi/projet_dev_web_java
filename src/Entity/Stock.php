...
class Stock
{
    ...
    #[ORM\Column(name: 'date_entree', type: 'datetime_immutable')]
    ...
    #[ORM\Column(name: 'date_derniere_mise_a_jour', type: 'datetime_immutable')]
    private \DateTimeImmutable $dateDerniereMiseAJour;

    #[ORM\Column(name: 'derniere_entree', type: 'datetime_immutable', nullable: true)]
    private ?\DateTimeImmutable $derniereEntree = null;

    #[ORM\Column(name: 'derniere_sortie', type: 'datetime_immutable', nullable: true)]
    private ?\DateTimeImmutable $derniereSortie = null;
    ...
    {
        $this->dateDerniereMiseAJour = new \DateTimeImmutable();
        $this->dateEntree = new \DateTimeImmutable();
        $this->movements = new ArrayCollection();
        $this->quantite = 0;
        $this->seuilAlerte = 10;
        $this->seuilCritique = 5;
    ...
    protected function setDateEntree(\DateTimeImmutable $dateEntree): static
    {
    ...
    public function getDateDerniereMiseAJour(): \DateTimeImmutable
    {
        return $this->dateDerniereMiseAJour;
    }

    protected function setDateDerniereMiseAJour(\DateTimeImmutable $dateDerniereMiseAJour): static
    {
        $this->dateDerniereMiseAJour = $dateDerniereMiseAJour;
        return $this;
    }

    public function getDerniereEntree(): ?\DateTimeImmutable
    {
        return $this->derniereEntree;
    }

    protected function setDerniereEntree(?\DateTimeImmutable $derniereEntree): static
    {
        $this->derniereEntree = $derniereEntree;
        return $this;
    }

    public function getDerniereSortie(): ?\DateTimeImmutable
    {
        return $this->derniereSortie;
    }

    protected function setDerniereSortie(?\DateTimeImmutable $derniereSortie): static
    {
    ...
    public function setQrCodeToken(#[\SensitiveParameter] ?string $qrCodeToken): static
    {
    ...
    {
        $produit = $this->produit ? $this->produit->getNom() : 'Non assigné';
        $depot = $this->depot ? $this->depot->getNomDepot() : 'Non assigné';
