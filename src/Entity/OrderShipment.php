...
class OrderShipment
{
    ...
    #[ORM\ManyToOne(targetEntity: Commande::class, inversedBy: 'shipments', cascade: ['persist'])]
    #[ORM\JoinColumn(name: 'id_commande_id', referencedColumnName: 'id_commande', nullable: false, onDelete: 'CASCADE')]
