...
class Traitement
{
    ...
    #[ORM\ManyToOne(targetEntity: Ordonnance::class, inversedBy: 'traitements', cascade: ['persist'])]
    #[ORM\JoinColumn(name: 'id_ordonnance_id', referencedColumnName: 'id_ordonnance', nullable: false, onDelete: 'CASCADE')]
    ...
    #[ORM\JoinColumn(name: 'id_produit_id', referencedColumnName: 'id_produit', nullable: true, onDelete: 'CASCADE')]
    ...
    #[ORM\Column(name: 'date_debut', type: 'datetime_immutable', nullable: true)]
