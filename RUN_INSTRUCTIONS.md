...
1. Right-click on `AppLauncher.java` in the project tree
2. Select `Run 'AppLauncher.main()'`
3. The application should launch

> Avoid running `CuraVitaApp` directly in some IDE configurations, because it can trigger:
